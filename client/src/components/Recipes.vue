<template>
  <div id="edit-text-w">
    ...
    <div class="menu-option-title">
      ...
      <div class="right">
        <span>Yemek Tarifi Al</span>
        <p>
          Tarifini öğrenmek istediğiniz yemeğin adını aşağıdaki alana yazın ve
    ...
    <div class="menu-option-content">
      <div class="form-item">
        <input
          ...
          v-model="text"
          placeholder="Örneğin; pirinç pilavı"
        />
        <span class="example-form-text">Örnek: pirinç pilavı</span>
      </div>
      <div class="form-item">
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      loadingText:
        "ChatGPT sizin için yemek tarifini hazırlıyor. Lütfen bekleyiniz...",
      postRes: false,
      postResC: "",
    };
  },
