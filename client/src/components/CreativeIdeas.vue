<template>
  <div id="edit-text-w">
    ...
    <div class="menu-option-title">
      ...
      <div class="right">
        <span>Yaratıcı Fikirler Bulun</span>
        <p>
          Yaratıcı fikirlere ulaşmak istediğiniz kelimeyi yazın ve
    ...
    <div class="menu-option-content">
      <div class="form-item">
        <input
          ...
          v-model="text"
          placeholder="Örneğin; dijital pazarlama"
        />
        <span class="example-form-text">Örnek: dijital pazarlama</span>
      </div>
      <div class="form-item">
