<template>
  <div id="edit-text-w">
    ...
    <div class="menu-option-title">
      <div class="left">
        <span><em class="fas fa-font"></em></span>
      </div>
      <div class="right">
        <span>İmla Düzeltme</span>
        <p>
          Belirlemiş olduğunuz yazıda bulunan imla hatalarını,
          <b>chatgpt</b> ile düzeltebilirsiniz. Bunun için aşağıdaki alana
          yazıyı girin ve <b>devam et </b> butonuna tıklayın.
          <b>Max: 120 karakter</b> girebilirsiniz.
        </p>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      loadingText:
        "ChatGPT sizin için imla hatalarını çözüyor. Lütfen bekleyiniz...",
      postRes: false,
      postResC: "",
    };
  },
  methods: {
    async create() {
      ...
      if (_length == 0) {
        ...
        this.errorContent =
          "Lütfen imla hatası düzeltilecek bir metin giriniz.";
      } else {
        let _data = {
          text: this.text,
          type: "fix",
