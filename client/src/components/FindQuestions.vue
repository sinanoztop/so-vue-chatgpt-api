<template>
  <div id="edit-text-w">
    ...
    <div class="menu-option-title">
      ...
      <div class="right">
        <span>Röportajınız için soru oluşturun</span>
        <p>
          Röportajınızın konusunu aşağıdaki alana yazın ve
    ...
    <div class="menu-option-content">
      <div class="form-item">
        <input
          ...
          v-model="text"
          placeholder="Örneğin; kuantum teknolojisi"
        />
        <span class="example-form-text">Örnek: kuantum teknolojisi</span>
      </div>
      <div class="form-item">
