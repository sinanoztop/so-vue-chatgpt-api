<template>
  <div id="edit-text-w">
    ...
    <div class="menu-option-title">
      ...
      <div class="right">
        <span>Yemek Fikri Al</span>
        <p>
          Yemek fikri alabilmek için elinizdeki malzemeleri aşağıdaki alana
          yazın ve
    ...
    <div class="menu-option-content">
      <div class="form-item">
        <input
          ...
          v-model="text"
          placeholder="Örneğin; 2 patlıcan, 1 domates, 2 biber, 3 yumurta"
        />
        <span class="example-form-text"
          >Örneğin; 2 patlıcan, 1 domates, 2 biber, 3 yumurta</span
        >
      </div>
      <div class="form-item">
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      loadingText:
        "ChatGPT sizin için yemek fikirleri hazırlıyor. Lütfen bekleyiniz...",
      postRes: false,
      postResC: "",
    };
  },
